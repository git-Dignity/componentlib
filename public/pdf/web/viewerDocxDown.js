...
var PDFViewerApplication = {
  ...
  download: function download() {
    ...
    xhr.setRequestHeader('sign', window.md5(nonce + '1970!@#$e102ebb2a8df821d6ae596a901180c036'))
    xhr.send()
    ...
    xhr.onload = function() {
      ...
      if (this.status === 200) {
        ...
        reader.onload = function(e) {
          ...
          // iso8859-1 转为utf-8
          // elink.download = decodeURI(escape(filename)) + '.docx' 
